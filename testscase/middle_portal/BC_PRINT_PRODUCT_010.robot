...
*** Test Cases ***
BC PRINT PRODUCT 010
    [Tags]           MIDDLE_WEIGHT  BC_PRINT_PRODUCT  BC_PRINT_PRODUCT_010
    [Documentation]  ทดสอบพิมพ์เอกสาร (คิวอาร์โค้ด : 2 คอลัมน์ [A4])
    # เริ่มต้นทดสอบ
    ...
    # ทดสอบ พิมพ์เอกสาร
    middle_portal_product_features.Print barcode  ${TC_010 ['test_data'] ['print_barcode']}
    # ตรวจสอบ พิมพ์เอกสาร
    middle_portal_product_features.Verify print barcode  ${code_product}  ${TC_010 ['test_data'] ['expect_print_barcode']}