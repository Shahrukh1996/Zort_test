...
*** Test Cases ***
BC PRINT PRODUCT 007
    [Tags]           MIDDLE_WEIGHT  BC_PRINT_PRODUCT  BC_PRINT_PRODUCT_007
    [Documentation]  ทดสอบพิมพ์เอกสาร (บาร์โค้ด : 3 คอลัมน์ [STK])
    # เริ่มต้นทดสอบ
    ...
    # ทดสอบ พิมพ์เอกสาร
    middle_portal_product_features.Print barcode  ${TC_007 ['test_data'] ['print_barcode']}
    # ตรวจสอบ พิมพ์เอกสาร
    middle_portal_product_features.Verify print barcode  ${code_product}  ${TC_007 ['test_data'] ['expect_print_barcode']}