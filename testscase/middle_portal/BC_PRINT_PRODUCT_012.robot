...
*** Test Cases ***
BC PRINT PRODUCT 012
    [Tags]           MIDDLE_WEIGHT  BC_PRINT_PRODUCT  BC_PRINT_PRODUCT_012
    [Documentation]  ทดสอบพิมพ์เอกสาร (คิวอาร์โค้ด : 1 คอลัมน์ [STK])
    # เริ่มต้นทดสอบ
    ...
    # ทดสอบ พิมพ์เอกสาร
    middle_portal_product_features.Print barcode  ${TC_012 ['test_data'] ['print_barcode']}
    # ตรวจสอบ พิมพ์เอกสาร
    middle_portal_product_features.Verify print barcode  ${code_product}  ${TC_012 ['test_data'] ['expect_print_barcode']}