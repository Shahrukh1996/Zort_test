...
*** Test Cases ***
BC PRINT PRODUCT 009
    [Tags]           MIDDLE_WEIGHT  BC_PRINT_PRODUCT  BC_PRINT_PRODUCT_009
    [Documentation]  ทดสอบพิมพ์เอกสาร (คิวอาร์โค้ด : แค็ตตาล็อก)
    # เริ่มต้นทดสอบ
    ...
    # ทดสอบ พิมพ์เอกสาร
    middle_portal_product_features.Print barcode  ${TC_009 ['test_data'] ['print_barcode']}
    # ตรวจสอบ พิมพ์เอกสาร
    middle_portal_product_features.Verify print barcode  ${code_product}  ${TC_009 ['test_data'] ['expect_print_barcode']}